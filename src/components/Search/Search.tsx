...
const Search: FC<Props> = ({
  ...
  const handleFacilityTypeChange = (event: ChangeEvent<HTMLSelectElement>) => {
  ...
  const handleFilterClick = () => {
    router.push(`/facilities?facilityType=${facilityTypeFilter}&searchQuery=${searchQuery}`);
  };

  return (
    <section className='bg-tertiary-light px-4 py-6 rounded-lg my-20'>
        ...
        <div className='w-full md:1/3 lg:w-auto mb-4 md:mb-0'>
          ...
          <div className='relative'>
            ...
            >
              ...
              <option value='ConferenceRoom'>ConferenceRoom</option>
